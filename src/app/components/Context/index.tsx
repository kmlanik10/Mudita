...
export const Context: React.FC<ContextProps> = ({ className, selected }) => {
  ...
  return (
    <div
      className={`flex flex-col overflow-y-auto rounded-lg border-gray-500 w-full ${className}`}
    >
      <div className="flex flex-col items-start sticky top-0 w-full">
        <div className="flex flex-col items-start lg:flex-row w-full lg:flex-wrap p-2">
          <p className="ml-2 mr-2 mt-2 text-white font-bold text-lg">
            Use one of our recommended planning philosophies to get started:
          </p>
        </div>
        <div className="flex flex-col items-start lg:flex-row w-full lg:flex-wrap p-2">
          {buttons}
